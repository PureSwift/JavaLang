...
@JavaClass("java.nio.charset.Charset", implements: Comparable<Charset>.self)
...
@JavaMethod
  ...
  /// ```
@JavaMethod
  open func newDecoder() -> CharsetDecoder!
  ...
  /// ```
@JavaMethod
  open func decode(_ arg0: ByteBuffer?) -> CharBuffer!

  /// Java method `newEncoder`.
  ///
  /// ### Java method signature
  /// ```java
  ...
  /// ```
@JavaMethod
  open func newEncoder() -> CharsetEncoder!
  ...
  /// ```
@JavaMethod
  open func encode(_ arg0: CharBuffer?) -> ByteBuffer!
